...
const resultsData = {
    ...
    tarot: [
        { icon: '🎩', imageUrl: 'https://raw.githubusercontent.com/krates98/tarotcardapi/main/images/the_magician.jpg', es: { name: 'El Mago', description: 'Manifestación y poder personal' }, en: { name: 'The Magician', description: 'Manifestation and personal power' }, pt: { name: 'O Mago', description: 'Manifestação e poder pessoal' } },
        { icon: '🌙', imageUrl: 'https://raw.githubusercontent.com/krates98/tarotcardapi/main/images/the_high_priestess.jpg', es: { name: 'La Sacerdotisa', description: 'Intuición y misterio' }, en: { name: 'The High Priestess', description: 'Intuition and mystery' }, pt: { name: 'A Sacerdotisa', description: 'Intuição e mistério' } },
        { icon: '👑', imageUrl: 'https://raw.githubusercontent.com/krates98/tarotcardapi/main/images/the_empress.jpg', es: { name: 'La Emperatriz', description: 'Abundancia y creatividad' }, en: { name: 'The Empress', description: 'Abundance and creativity' }, pt: { name: 'A Imperatriz', description: 'Abundância e criatividade' } },
        { icon: '⚜️', imageUrl: 'https://raw.githubusercontent.com/krates98/tarotcardapi/main/images/the_emperor.jpg', es: { name: 'El Emperador', description: 'Autoridad y estructura' }, en: { name: 'The Emperor', description: 'Authority and structure' }, pt: { name: 'O Imperador', description: 'Autoridade e estrutura' } },
        { icon: '📿', imageUrl: 'https://raw.githubusercontent.com/krates98/tarotcardapi/main/images/the_hierophant.jpg', es: { name: 'El Hierofante', description: 'Tradición y sabiduría' }, en: { name: 'The Hierophant', description: 'Tradition and wisdom' }, pt: { name: 'O Hierofante', description: 'Tradição e sabedoria' } },
        { icon: '💕', imageUrl: 'https://raw.githubusercontent.com/krates98/tarotcardapi/main/images/the_lovers.jpg', es: { name: 'Los Enamorados', description: 'Elección y armonía' }, en: { name: 'The Lovers', description: 'Choice and harmony' }, pt: { name: 'Os Enamorados', description: 'Escolha e harmonia' } },
        { icon: '🏇', imageUrl: 'https://raw.githubusercontent.com/krates98/tarotcardapi/main/images/the_chariot.jpg', es: { name: 'El Carro', description: 'Voluntad y determinación' }, en: { name: 'The Chariot', description: 'Willpower and determination' }, pt: { name: 'O Carro', description: 'Vontade e determinação' } },
        { icon: '🦁', imageUrl: 'https://raw.githubusercontent.com/krates98/tarotcardapi/main/images/strength.jpg', es: { name: 'La Fuerza', description: 'Coraje y compasión' }, en: { name: 'Strength', description: 'Courage and compassion' }, pt: { name: 'A Força', description: 'Coragem e compaixão' } },
        { icon: '🕯️', imageUrl: 'https://raw.githubusercontent.com/krates98/tarotcardapi/main/images/the_hermit.jpg', es: { name: 'El Ermitaño', description: 'Introspección y guía interior' }, en: { name: 'The Hermit', description: 'Introspection and inner guidance' }, pt: { name: 'O Eremita', description: 'Introspecção e guia interior' } },
        { icon: '☸️', imageUrl: 'https://raw.githubusercontent.com/krates98/tarotcardapi/main/images/wheel_of_fortune.jpg', es: { name: 'La Rueda de la Fortuna', description: 'Cambio y destino' }, en: { name: 'Wheel of Fortune', description: 'Change and destiny' }, pt: { name: 'A Roda da Fortuna', description: 'Mudança e destino' } },
        { icon: '⚖️', imageUrl: 'https://raw.githubusercontent.com/krates98/tarotcardapi/main/images/justice.jpg', es: { name: 'La Justicia', description: 'Equilibrio y verdad' }, en: { name: 'Justice', description: 'Balance and truth' }, pt: { name: 'A Justiça', description: 'Equilíbrio e verdade' } },
        { icon: '🙃', imageUrl: 'https://raw.githubusercontent.com/krates98/tarotcardapi/main/images/the_hanged_man.jpg', es: { name: 'El Colgado', description: 'Perspectiva y sacrificio' }, en: { name: 'The Hanged Man', description: 'Perspective and sacrifice' }, pt: { name: 'O Enforcado', description: 'Perspectiva e sacrifício' } },
        { icon: '💀', imageUrl: 'https://raw.githubusercontent.com/krates98/tarotcardapi/main/images/death.jpg', es: { name: 'La Muerte', description: 'Transformación y renacimiento' }, en: { name: 'Death', description: 'Transformation and rebirth' }, pt: { name: 'A Morte', description: 'Transformação e renascimento' } },
        { icon: '🍷', imageUrl: 'https://raw.githubusercontent.com/krates98/tarotcardapi/main/images/temperance.jpg', es: { name: 'La Templanza', description: 'Moderación y paciencia' }, en: { name: 'Temperance', description: 'Moderation and patience' }, pt: { name: 'A Temperança', description: 'Moderação e paciência' } },
        { icon: '😈', imageUrl: 'https://raw.githubusercontent.com/krates98/tarotcardapi/main/images/the_devil.jpg', es: { name: 'El Diablo', description: 'Tentación y liberación' }, en: { name: 'The Devil', description: 'Temptation and liberation' }, pt: { name: 'O Diabo', description: 'Tentação e libertação' } },
        { icon: '🗼', imageUrl: 'https://raw.githubusercontent.com/krates98/tarotcardapi/main/images/the_tower.jpg', es: { name: 'La Torre', description: 'Revelación y cambio súbito' }, en: { name: 'The Tower', description: 'Revelation and sudden change' }, pt: { name: 'A Torre', description: 'Revelação e mudança súbita' } },
        { icon: '⭐', imageUrl: 'https://raw.githubusercontent.com/krates98/tarotcardapi/main/images/the_star.jpg', es: { name: 'La Estrella', description: 'Esperanza y renovación' }, en: { name: 'The Star', description: 'Hope and renewal' }, pt: { name: 'A Estrella', description: 'Esperança e renovação' } },
        { icon: '🌕', imageUrl: 'https://raw.githubusercontent.com/krates98/tarotcardapi/main/images/the_moon.jpg', es: { name: 'La Luna', description: 'Ilusión y subconsciente' }, en: { name: 'The Moon', description: 'Illusion and subconscious' }, pt: { name: 'A Lua', description: 'Ilusão e subconsciente' } },
        { icon: '☀️', imageUrl: 'https://raw.githubusercontent.com/krates98/tarotcardapi/main/images/the_sun.jpg', es: { name: 'El Sol', description: 'Alegría y éxito' }, en: { name: 'The Sun', description: 'Joy and success' }, pt: { name: 'O Sol', description: 'Alegria e sucesso' } },
        { icon: '📯', imageUrl: 'https://raw.githubusercontent.com/krates98/tarotcardapi/main/images/judgement.jpg', es: { name: 'El Juicio', description: 'Renacimiento y reflexión' }, en: { name: 'Judgement', description: 'Rebirth and reflection' }, pt: { name: 'O Julgamento', description: 'Renascimento e reflexão' } },
        { icon: '🌍', imageUrl: 'https://raw.githubusercontent.com/krates98/tarotcardapi/main/images/the_world.jpg', es: { name: 'El Mundo', description: 'Completitud y logro' }, en: { name: 'The World', description: 'Completion and achievement' }, pt: { name: 'O Mundo', description: 'Completude e realização' } },
        { icon: '🃏', imageUrl: 'https://raw.githubusercontent.com/krates98/tarotcardapi/main/images/the_fool.jpg', es: { name: 'El Loco', description: 'Nuevos comienzos y aventura' }, en: { name: 'The Fool', description: 'New beginnings and adventure' }, pt: { name: 'O Louco', description: 'Novos começos e aventura' } }
    ],
    elements: [
...
function displayResults(results) {
    ...
    let cardsHTML = `
        ...
        <div class="result-card">
            <div class="result-icon tarot-card">
                <img src="${results.tarot.imageUrl}" alt="${tarotData.name}" class="tarot-img" onerror="this.style.display='none'; this.parentElement.innerHTML='${results.tarot.icon}'">
            </div>
